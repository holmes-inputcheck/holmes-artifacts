...
if [ ! -f "$FILE0" ]; then
    printf "%s,%s,%s,%s,%s,%s\n" $t0 $t1 $t2 $t3 $t4 $t5 > $FILE0
fi

if [ ! -f "$FILE1" ]; then
    printf "%s,%s,%s,%s,%s,%s\n" $t0 $t6 $t7 $t8 $t9 $t10 > $FILE1
fi

if [ ! -f "$FILE2" ]; then
    printf "%s,%s,%s,%s,%s,%s\n" $t0 $t11 $t12 $t13 $t14 $t15 > $FILE2
fi
